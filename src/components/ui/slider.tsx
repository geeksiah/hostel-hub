    ...
    >
      ...
      {thumbValues.map((_, index) => (
        <SliderPrimitive.Thumb
          ...
          key={index}
          className="block h-5 w-5 rounded-full border-2 border-background bg-secondary shadow-[0_4px_10px_rgba(16,24,40,0.12)] ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
        />
      ))}
    </SliderPrimitive.Root>
  );
